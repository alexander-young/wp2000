...
function wp2k_scripts() {
  ...
  wp_enqueue_style( 'wp2k-style', get_stylesheet_directory_uri() . '/assets/dist/css/style.css' );
  ...
  wp_enqueue_script( 'vendor-js', get_stylesheet_directory_uri() . '/assets/dist/js/vendor.js', ['jquery' ], '1.0.0', true );
  wp_enqueue_script( 'main-js', get_stylesheet_directory_uri() . '/assets/dist/js/main.js', [ 'jquery', 'vendor-js' ], '1.0.0', true );
