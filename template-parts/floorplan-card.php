...
<div class="shadow-md">
  ...
  <div class="relative">
    ...
    <div class="absolute flex flex-col justify-end bg-gradient-black px-4 py-3 inset-0">
      ...
      <div class="text-gray-100 text-2xl leading-tight"><?php echo \WP2K\Helpers::format_floorplan_price( get_post_meta( $post_id, 'starting_price', true ) ); ?></div>
    </div>
  ...
  <div class="flex items-center bg-gray-100 px-4 pt-4 pb-2">
    <div>
      ...
      <?php \WP2K\Helpers::display_floorplan_meta( $post_id ); ?>
    </div>
  </div>
  ...
  <div class="px-4 p-2">
    <?php \WP2K\Helpers::display_floorplan_features( $post_id ); ?>
  </div>
